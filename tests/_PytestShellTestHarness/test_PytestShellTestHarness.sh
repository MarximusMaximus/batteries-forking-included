...
#===============================================================================
#region Test_PytestShellTestHarness__run


#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__test_PytestShellTestHarness__run__success()
{
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__test_PytestShellTestHarness__run__assert() {
    # this shouldn't get called due to mock_subprocess_run, fail if it is
    exit 1
}

#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_success() {
    (
        command printf "foo\n"
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_assert_pass() {
    (
        command printf "foo\n"
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_assert_fail() {
    (
        script_ret=0
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___main_invoked() {
    (
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___main() {
    (
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___main_overridden() {
    (
        _CALL_MAIN_ANYWAY=true
        export _CALL_MAIN_ANYWAY
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___main_overridden_custom() {
    (
        _CALL_MAIN_ANYWAY=true
        export _CALL_MAIN_ANYWAY
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___sourced_main() {
    (
        inject_monkeypatch() { true; }
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___sourced_main_overridden() {
    (
        include_G ./example_shell_script.sh "$@"
        script_ret=$?
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell___sourced_main_overridden_custom() {
    (
        inject_monkeypatch() {
            __sourced_main() {
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_public_function() {
    (
        include_G ./example_shell_script.sh "$@"
        script_ret=$?
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_public_function_overridden() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_public_function_overridden_assert_pass() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_public_function_overridden_assert_fail() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_private_function() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_private_function_overridden() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_private_function_overridden_assert_pass() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_PytestShellTestHarness__run__test_PytestShellTestHarness__run__shell_private_function_overridden_assert_fail() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#endregion Test_PytestShellTestHarness__run
#===============================================================================
