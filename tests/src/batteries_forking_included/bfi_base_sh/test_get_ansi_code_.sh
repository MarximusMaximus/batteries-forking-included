...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__regular_terminal() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__mono_terminal() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__tput_colors_8() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__tput_colors_16() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__tput_colors_256() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__NO_COLOR_empty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__NO_COLOR_nonempty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__colorized_output_empty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__colorized_output_true() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__colorized_output_alt() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor__test_get_ansi_code_cursor__colorized_output_false() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_up__test_get_ansi_code_cursor_up() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_down__test_get_ansi_code_cursor_down() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_right__test_get_ansi_code_cursor_right() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_left__test_get_ansi_code_cursor_left() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_nextline__test_get_ansi_code_cursor_nextline() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_prevline__test_get_ansi_code_cursor_prevline() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_col__test_get_ansi_code_cursor_col() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code_cursor_pos__test_get_ansi_code_cursor_pos() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
