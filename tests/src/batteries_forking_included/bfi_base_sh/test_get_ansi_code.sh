...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__terminal_regular() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__terminal_mono() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__tput_colors_16() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__tput_colors_256() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__NO_COLOR_empty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__NO_COLOR_nonempty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__colorized_output_empty() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__colorized_output_true() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__colorized_output_alt() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
...
#-------------------------------------------------------------------------------
Test_get_ansi_code__test_get_ansi_code__colorized_output_false() {
    (
        inject_monkeypatch() {
            default_inject_monkeypatch
