...
#-------------------------------------------------------------------------------
Test_return_code_is_error__test_return_code_is_error() {
    (
...
#-------------------------------------------------------------------------------
Test_return_code_is_warning__test_return_code_is_warning() {
    (
        include_G ./bfi-base.sh "$@"
        script_ret=$?
        if [ "${script_ret}" -ne 0 ]; then
...
#-------------------------------------------------------------------------------
Test_return_code_is_success__test_return_code_is_success() {
    (
        include_G ./bfi-base.sh "$@"
        script_ret=$?
        if [ "${script_ret}" -ne 0 ]; then
